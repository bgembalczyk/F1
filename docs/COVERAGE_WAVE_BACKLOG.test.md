...
- [ ] `scrapers/points/parsers.py` - miss: 78, coverage: 55.68%
...
- [ ] `scrapers/base/abc.py` - miss: 86, coverage: 59.05%
...
- [ ] `scrapers/base/scraper_components.py` - miss: 59, coverage: 68.45%
- [ ] `scrapers/base/table/columns/types/links_list.py` - miss: 58, coverage: 25.64%
- [ ] `scrapers/circuits/models/services/lap_record_utils.py` - miss: 55, coverage: 42.11%
