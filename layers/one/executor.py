...
class EngineManufacturersRunnerProtocol(Protocol):
    def __call__(self, *, base_wiki_dir: Path, include_urls: bool) -> None: ...
...
class LayerOneExecutor:
    def __init__(
        ...
        *,
        ...
        engine_manufacturers_runner: EngineManufacturersRunnerProtocol,
    ) -> None:
