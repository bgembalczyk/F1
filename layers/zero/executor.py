...
class LayerZeroExecutor:
    def __init__(
        ...
        *,
        ...
        should_mirror_constructors_job: Callable[[ListJobRegistryEntry], bool],
        ...
        self._should_mirror_constructors_job = should_mirror_constructors_job
    ...
    def run(self, run_config: RunConfig, base_wiki_dir: Path) -> None:
        ...
        for job in self._list_job_registry:
            ...
            if self._should_mirror_constructors_job(job):
