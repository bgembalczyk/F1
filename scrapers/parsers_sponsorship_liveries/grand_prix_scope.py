...
from scrapers.sponsorship_liveries.parsers_sponsorship_liveries import GrandPrixScopeAccumulator
from scrapers.sponsorship_liveries.parsers_sponsorship_liveries import SponsorshipRecordText
