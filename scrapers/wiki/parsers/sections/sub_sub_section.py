...
class SubSubSectionParser(WikiParser):
            ...
            sub_sections.append(
                {
                    ...
                    **self.sub_sub_sub_section_parser.parse_group(group_elements, context=child_context),
                }
            )
        return {"sub_sub_sub_sections": sub_sections}
