...
from scrapers.grands_prix.helpers_grands_prix.constants import GRAND_PRIX_KEYWORD
from scrapers.grands_prix.helpers_grands_prix.constants import GRAND_PRIX_NAVBOX_TEMPLATE
