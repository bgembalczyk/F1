...
def circuit_section_entries(*, options: ScraperOptions, url: str) -> list[SectionAdapterEntry]:
    return [
        SectionAdapterEntry(
            ...
            aliases=profile_entry_aliases("circuits", "layout_history", "Layout_history", "History"),
            parser=CircuitLayoutHistorySectionParser(),
        ),
        SectionAdapterEntry(
            section_id="lap_records",
            aliases=profile_entry_aliases("circuits", "lap_records", "Lap_records", "Formula_One_lap_records"),
