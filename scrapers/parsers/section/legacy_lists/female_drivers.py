...
from scrapers.constants.constants_drivers import FEMALE_DRIVER_ENTRIES_STARTS_HEADER
from scrapers.constants.constants_drivers import FEMALE_DRIVER_NAME_HEADER
from scrapers.constants.constants_drivers import FEMALE_DRIVER_POINTS_HEADER
from scrapers.constants.constants_drivers import FEMALE_DRIVER_SEASONS_HEADER
...
class DriversSectionParser(RecursiveSectionParser):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(
            child_parser=child_parser or OfficialDriversSubSectionParser(toolbox=toolbox),
            toolbox=toolbox,
        )
