...
class TyreManufacturersBySeasonSubSectionParser(SubSectionParser, SubSectionParserABC):
...
class ManufacturersSectionParser(NestedWikiSectionParser, SectionParserABC):
