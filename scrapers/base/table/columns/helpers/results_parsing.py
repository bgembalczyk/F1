...
def parse_points_value(text: str) -> float | None:
    """Parse points value. Deprecated: Use ResultsParsingHelpers.parse_points_value()"""
    return ResultsParsingHelpers.parse_points_value(text)


def parse_results(text: str) -> list[dict[str, Any]]:
    """Parse results. Deprecated: Use ResultsParsingHelpers.parse_results()"""
    return ResultsParsingHelpers.parse_results(text)


def parse_superscripts(ctx: ColumnContext) -> tuple[int | None, bool, bool]:
    """Parse superscripts. Deprecated: Use ResultsParsingHelpers.parse_superscripts()"""
    return ResultsParsingHelpers.parse_superscripts(ctx)
...
def parse_entrant_segment(
    ...
    """Parse entrant segment. Deprecated: Use ResultsParsingHelpers.parse_entrant_segment()"""
    return ResultsParsingHelpers.parse_entrant_segment(segment, link_lookup, base_url)


def extract_licenses(segments: list[Tag], base_url: str) -> list[dict[str, str]]:
    """Extract licenses. Deprecated: Use ResultsParsingHelpers.extract_licenses()"""
    return ResultsParsingHelpers.extract_licenses(segments, base_url)


def strip_refs(segment: Tag) -> None:
    """Strip refs. Deprecated: Use ResultsParsingHelpers.strip_refs()"""
    return ResultsParsingHelpers.strip_refs(segment)


def extract_number(text: str) -> int | None:
    """Extract number. Deprecated: Use ResultsParsingHelpers.extract_number()"""
    return ResultsParsingHelpers.extract_number(text)


def extract_race_result_background(cell: Tag) -> str | None:
    """Extract race result background. Deprecated: Use ResultsParsingHelpers.extract_race_result_background()"""
    return ResultsParsingHelpers.extract_race_result_background(cell)


def has_year(text: str) -> bool:
    """Check has year. Deprecated: Use ResultsParsingHelpers.has_year()"""
    return ResultsParsingHelpers.has_year(text)
