...
DEPRECATED_MODULES: tuple[DeprecatedModuleEntry, ...] = (
    DeprecatedModuleEntry("scrapers.circuits.list_scraper", "scrapers.circuits.entrypoint"),
    DeprecatedModuleEntry("scrapers.circuits.complete_scraper"),
    DeprecatedModuleEntry("scrapers.constructors.current_constructors_list", "scrapers.constructors.entrypoint"),
    ...
    DeprecatedModuleEntry("scrapers.drivers.list_scraper", "scrapers.drivers.entrypoint"),
    ...
    DeprecatedModuleEntry("scrapers.engines.indianapolis_only_engine_manufacturers_list"),
    ...
    DeprecatedModuleEntry("scrapers.grands_prix.list_scraper", "scrapers.grands_prix.entrypoint"),
    DeprecatedModuleEntry("scrapers.grands_prix.complete_scraper"),
    DeprecatedModuleEntry("scrapers.grands_prix.red_flagged_races_scraper.world_championship"),
    ...
    DeprecatedModuleEntry("scrapers.seasons.list_scraper", "scrapers.seasons.entrypoint"),
