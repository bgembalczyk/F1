...
def test_event_field_supports_string_or_list_of_links_and_reports_invalid_items() -> None:
...
def test_event_record_representation_and_serialization_are_plain_json_friendly() -> None:
    record: EventRecord = {
        "event": "Mille Miglia",
        "championship": False,
    }
