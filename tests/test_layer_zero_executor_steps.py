    ...
    *,
    ...
    return LayerZeroExecutor(
        ...
        run_and_export_function=(
            run_and_export_function if run_and_export_function else lambda *_a, **_k: None
        ),
...
def test_run_single_job_passes_local_run_config_when_kwargs_present() -> None:
    ...
    executor = _executor(
        run_and_export_function=lambda scraper_cls, json_path, csv_path, run_config: calls.append(
            {
