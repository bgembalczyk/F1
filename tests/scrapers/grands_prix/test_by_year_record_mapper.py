...
from scrapers.grands_prix.mappers_grands_prix.by_year_record import GrandPrixByYearRecordInput
from scrapers.grands_prix.mappers_grands_prix.by_year_record import GrandPrixByYearRecordMapper
